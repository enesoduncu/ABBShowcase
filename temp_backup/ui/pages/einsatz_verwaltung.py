...
from models.einsatz import SchulartEnum
...
def einsatz_form(einsatz_service: EinsatzService) -> bool:
    ...
    with st.form("einsatz_form"):
        ...
        with col1:
            ...
            schulart = st.selectbox(
                "Schulart *", 
                ["Bitte wählen..."] + [e.value for e in SchulartEnum],
                index=0
            )
        ...
        with col2:
            studienbotschafter = st.checkbox("Studienbotschafter")
            ...
            if validate_einsatz_form(schulname, schulart, stadt, landkreis, klassenstufe):
                try:
                    ...
                    einsatz_data = EinsatzCreate(
                        name=schulname,
                        beschreibung=f"Schulart: {schulart}, Stadt: {stadt}, Landkreis: {landkreis}, Partner: {partner}, Studienbotschafter: {studienbotschafter}, Online: {online}, Klassenstufe: {klassenstufe}, Schüleranzahl: {schueleranzahl}",
    ...
    try:
        ...
        for einsatz in einsaetze:
            data.append({
                ...
                'Studienbotschafter': 'Ja' if einsatz.get('studienbotschafter') else 'Nein',
